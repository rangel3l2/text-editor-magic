  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Vamos salvar seu trabalho?</DialogTitle>
          <DialogDescription>
            Para continuar editando e salvar seu trabalho automaticamente, 
            faça login com sua conta Google. É rápido e seguro!
          </DialogDescription>
        </DialogHeader>
